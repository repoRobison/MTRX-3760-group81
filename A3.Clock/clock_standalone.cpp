...
//---CAlarmClock---------------------------------------------------------------
// A standalone CAlarmClock keeps a time and an alarm time. It deliberately does
// not inherit from CClock, so the ordinary clock behaviour is repeated here.
class CAlarmClock
{
  public:
...
//---main----------------------------------------------------------------------
// Uses a plain clock and a standalone alarm clock. The alarm clock advances
